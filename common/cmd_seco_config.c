...
/*  __________________________________________________________________________
 * |_____________________________ USBC_iMX6 (A62-HMI-10) ____________________________|
 */
#if defined (CONFIG_TARGET_MX6SECO_USBC_A62_10)
static data_boot_dev_t kern_dev_list [] = {
	{ DEV_EMMC,     "eMMC onboard",   ENV_KERNEL_SRC_MMC,    BOOT_DEV_ID_EMMC,    LOAD_ADDR_KERNEL_LOCAL_DEV,   "zImage" },
...
#endif   /*  defined(CONFIG_TARGET_MX6SECO_USBC_A62_10)  */
...
#define MAX_PARTITION_ID 9
	...
	#define MAX_DEVICE 1
	#endif
#elif defined CONFIG_TARGET_MX6SECO_USBC_A62_10
	#if defined(CONFIG_MX6Q)
	#define MAX_DEVICE 2
	#else
	#define MAX_DEVICE 1
